...
# gnome-session 50 hardcoded systemd as required, elogind support dropped upstream
# cry me a river atp, I use systemd anyway
# see meson.build line 89: libsystemd_dep = dependency('libsystemd', required: true)
