...
"
PATCHES=(
	# as per upstream, all mentioned issues have their fixes merged
	# within GNOME 50, so figured I drop the patches besides for the
	# one I can't confirm yet.

	# bug #964367
	"${FILESDIR}/gnome-keyring-50.0-fix-pam-install.patch"
)
