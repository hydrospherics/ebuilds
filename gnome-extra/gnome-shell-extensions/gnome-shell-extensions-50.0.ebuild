...
# No IUSE needed - x11 option gone, purely JS extensions now
DEPEND="
...
RDEPEND="${DEPEND}
	...
	>=x11-wm/mutter-50.0[introspection]
"
BDEPEND="
...
DOC_CONTENTS="Installed extensions are initially disabled by default.
